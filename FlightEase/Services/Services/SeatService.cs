...
namespace Services.Services
{
    ...
    {
        Task<ResultModel> GetSeatsAsync(int flightId);
    }
    public class SeatService : ISeatService
    {
        ...
        public async Task<ResultModel> GetSeatsAsync(int flightId)
        {
            ...
            var seats = _seatRepository.Get()
                .Where(s => s.PlaneId == flight.PlaneId && s.SeatNumer >= 1 && s.SeatNumer <= 42)
