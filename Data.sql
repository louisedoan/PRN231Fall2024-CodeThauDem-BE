...
('Plane001', 42, 'Available'),
('Plane002', 42, 'Available'),
('Plane003', 42, 'Available');
...
(101, 1, 1, '2024-11-12 08:00:00', 2, '2024-11-13 18:00:00', 'Available'),
(102, 2, 2, '2024-11-12 09:00:00', 3, '2024-11-12 23:00:00', 'Available'),
(103, 3, 2, '2024-11-14 10:00:00', 1, '2024-11-15 20:00:00', 'Available');
...
BEGIN
    INSERT INTO Seat (PlaneID, SeatNumer, Class, Status, Price) VALUES
    (3, @i, CASE WHEN @i <= 12 THEN 'Business' ELSE 'Economy' END, 'Available', CASE WHEN @i <= 12 THEN 2000000 ELSE 1500000 END);
    SET @i = @i + 1;
END